                        ...
                        <tr style="border-collapse:collapse">
                            <td align="center" style="padding:0;Margin:0">
                                <table class="es-footer-body" cellspacing="0" cellpadding="0" align="center"
                                    bgcolor="#54cc61"
                                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#54cc61;width:600px;color: #403f3b;font-size: 18px">
                                    <tr style="border-collapse:collapse">
                                        <td align="{{ App::isLocale('ar') ? 'right' : 'left' }}"
                                            ...
                                            <table cellspacing="0" cellpadding="0" width="100%"
                                                ...
                                                <tr style="border-collapse:collapse">
                                                    <td align="{{ App::isLocale('ar') ? 'right' : 'left' }}"
                                                        style="padding:0;Margin:0;width:560px;text-align: center;font-size: 10px;color: #403f3b">
