...
@section('title',settings()->website_title .' | '. __('words.order_products'))
@section('breadcrumb')
    <div class="d-flex align-items-baseline flex-wrap mr-5">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item">
                <apan class="text-muted">{{__('words.show_order_products')}}</apan>
            </li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap py-5">
            <div class="card-title">
                <h3 class="card-title">{{__('words.show_order_products')}}</h3>
            </div>
            ...
            <div class="card-toolbar">
                ...
                <div class="dropdown dropdown-inline mr-2">
                    <!--begin::Button-->
                    @permission('create-order_products')
                    <a href="{{route('order_products.create')}}" class="btn btn-primary font-weight-bolder">
