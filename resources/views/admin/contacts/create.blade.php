                ...
                <div class="form-group col-6">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control" id="type" name="type">
                            ...
                            <option
                                value="phone" {{old('type') == 'phone' ? 'selected' : ''}}>{{__('words.phone')}}</option>
                            <option
                                value="email" {{old('type') == 'email' ? 'selected' : ''}}>{{__('words.email')}}</option>
                            <option
                                value="social" {{old('type') == 'social' ? 'selected' : ''}}>{{__('words.social')}}</option>
