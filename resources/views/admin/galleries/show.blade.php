                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-7 bg-light p-5 rounded h-100">
                                    ...
                                    <p class="m-0">{{ $gallery->translate($locale)->title }}</p>
                                </div>
                            </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        <div class="mb-7 bg-light p-5 rounded h-100">
                            ...
                            <p class="m-0">{{ createdAtFormat($gallery->created_at) }}</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-7 bg-light p-5 rounded h-100">
                            ...
                            <p class="m-0">{{ createdAtFormat($gallery->created_at) == updatedAtFormat($gallery->updated_at) ? '--' : updatedAtFormat($gallery->updated_at) }}</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-7 bg-light p-5 rounded h-100">
                            ...
                            <p class="m-0">{{ $gallery->getActive() }}</p>
                        </div>
                    </div>
