...
@section('title',settings()->website_title .' | '. __('words.edit_gallery'))
@section('breadcrumb')
    <div class="d-flex align-items-baseline flex-wrap mr-5">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item">
                <apan class="text-muted">{{__('words.edit_gallery')}}</apan>
            </li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
    ...
    <div class="card card-custom mb-2">
        <div class="card-header card-header-tabs-line">
            <div class="card-title">
                <h3 class="card-label">{{__('words.edit_gallery')}}</h3>
            </div>
    ...
    <div class="card card-custom">
        <div class="card-body">
            ...
            <div class="form-group row">
                @include('admin.components.image',['label'=>__('words.image'),'value'=>old('image',$gallery->image),'name'=>'image','id'=>'kt_image_3'])

                @include('admin.components.switch',['label'=>__('words.status'),'name'=>'status','val' => old('status',$gallery->status)])
            </div>
