...
@section('content')
    ...
    <form action="{{route('settings.update',$setting->id)}}" method="POST" autocomplete="off"
        ...
        <div class="card-body">
            ...
            <div class="card card-custom">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="d-block">{{__('words.logo')}}</label>
            ...
            @if(auth('admin')->user()->hasPermission('update-settings'))
