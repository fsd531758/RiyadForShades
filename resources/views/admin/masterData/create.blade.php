...
@section('breadcrumb')
    <div class="d-flex align-items-baseline flex-wrap mr-5">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item">
                <apan class="text-muted">{{__('words.create_master')}}</apan>
            </li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
...
@section('content')
    ...
    <div class="card-body">
        ...
        <form action="{{route('master-data.store')}}" method="POST" autocomplete="off"
                ...
                <div class="card card-custom mb-2">
                    <div class="card-header card-header-tabs-line">
                        <div class="card-title">
                            <h3 class="card-label">{{__('words.create_master')}}</h3>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="form-group row">
                                <div class="col-6">
                                    ...
                                    "application/msword, application/vnd.ms-excel, application/vnd.ms-powerpoint,text/plain, application/pdf" id="formFileSm" type="file">
                                </div>
                            </div>
                        </div>
                    </div>
