...
@section('title',settings()->website_title .' | '. __('words.features'))
@section('breadcrumb')
    <div class="d-flex align-items-baseline flex-wrap mr-5">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item">
                <apan class="text-muted">{{__('words.show_features')}}</apan>
            </li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap py-5">
            <div class="card-title">
                <h3 class="card-title">{{__('words.show_features')}}</h3>
            </div>
                ...
                <table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
                    ...
                    @foreach($features as $key => $feature)
                        <tr>
                            ...
                            <td nowrap="nowrap">
                                @include('admin.components.form-controls', ['name'=>'features', 'value'=>$feature,'role'=>'features'])
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
