...
@section('breadcrumb')
    <div class="d-flex align-items-baseline flex-wrap mr-5">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item">
                <apan class="text-muted">{{__('words.edit_feature')}}</apan>
            </li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
                    ...
                    <div class="tab-pane fade show @if ($key == 0) active @endif" id="{{ $locale }}"
                        ...
                        {{-- <div class="col form-group">
                            ...
                            <textarea
                                ...
                                rows="4">{{ old($locale . '.description',$feature->translate($locale)->description) }} </textarea>
    ...
    <div class="card card-custom">
        <div class="card-body">
            <div class="form-group row">
                @include('admin.components.icon',['label'=>__('words.icon'),'value'=>old('icon',$feature->icon)])
            </div>
