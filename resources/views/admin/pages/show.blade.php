...
@section('breadcrumb')
    <div class="d-flex align-items-baseline flex-wrap mr-5">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item">
                <apan class="text-muted">{{__('words.show_page')}}</apan>
            </li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        <div class="mb-7 bg-light p-5 rounded h-100">
                            ...
                            <p class="m-0">{{ createdAtFormat($page->created_at) == updatedAtFormat($page->updated_at) ? '--' : updatedAtFormat($page->updated_at) }}</p>
                        </div>
                    </div>
