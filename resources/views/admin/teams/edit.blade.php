...
@section('breadcrumb')
    <div class="d-flex align-items-baseline flex-wrap mr-5">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item">
                <apan class="text-muted">{{__('words.edit_team')}}</apan>
            </li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
...
@section('form_content')
                    ...
                    <div class="tab-pane fade show @if ($key == 0) active @endif" id="{{ $locale }}"
                        ...
                        <div class="col form-group">
                            ...
                            <textarea
                                ...
                                rows="4">{{ old($locale . '.description',$team->translate($locale)->description) }} </textarea>
    ...
    <div class="card card-custom">
        <div class="card-body">
                ...
                <div class="input-group col-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="facebook" class="form-control link @error('facebook') is-invalid @enderror"
                               value="{{ old('facebook',$team->facebook) }}" placeholder="{{__('words.facebook')}}">
            ...
            <div class="form-group row">
                @include('admin.components.file',['label'=>__('words.image'),'value'=>old('image',$team->image),'name'=>'image','id'=>'kt_image_3','accept' =>'image/*'])

                @include('admin.components.switch',['label'=>__('words.status'),'name'=>'status','val' => old('status',$team->status)])
            </div>
