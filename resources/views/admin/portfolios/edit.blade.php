...
@section('breadcrumb')
    <div class="d-flex align-items-baseline flex-wrap mr-5">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item">
                <apan class="text-muted">{{__('words.edit_portfolio')}}</apan>
            </li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
                    ...
                    <div class="tab-pane fade show @if ($key == 0) active @endif" id="{{ $locale }}"
                        ...
                        <div class="col form-group">
                            ...
                            <textarea
                                ...
                                rows="4">{{ old($locale . '.description',$portfolio->translate($locale)->description) }} </textarea>
    ...
    <div class="card card-custom">
        <div class="card-body">
            <div class="form-group row">
                @include('admin.components.file',['label'=>__('words.image'),'value'=>old('image',$portfolio->image),'name'=>'image','id'=>'kt_image_3','accept' =>'image/*'])

                @include('admin.components.files',['label'=>__('words.files'),'name'=>'files[]','accept' => 'application/msword, application/vnd.ms-excel, application/vnd.ms-powerpoint,text/plain, application/pdf'])
            </div>
            ...
            <br>
            <div class="form-group row">
                @include('admin.components.switch',['label'=>__('words.status'),'name'=>'status','val' => old('status',$portfolio->status)])
            </div>
