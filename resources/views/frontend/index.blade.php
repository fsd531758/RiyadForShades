...
@section('content')
 ...
 <div class="intro intro-carousel swiper position-relative">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide carousel-item-a intro-item bg-image" style="background-image: url({{asset($slide->image)}})">
                ...
                <div class="row">
                  <div class="col-lg-8">
                    <div class="intro-body">
                      ...
                      <p class="intro-subtitle intro-price"><a href="{{ route('about') }}"><span class="price-a">تعرف علينا</span></a></p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="icon-box section-b2">
                  ...
                  <div class="icon-box-content table-cell">
                    ...
                    <div class="icon-box-content">
                      <p class="mb-1">البريد الإلكتروني: <span class="color-a">contact@example.com</span></p>
